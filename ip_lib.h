...
/* Restituisce un valore calcolato attraverso la formula della curva gaussiana */
...
/* Restituisce il valore ottenuto dalla convoluzione delle due matrici passate come parametri */
float convpixel (ip_mat * sub_a, ip_mat * f, int k);

/* Riempie la matrice con i valore contenuti nel vettore passato come parametro */
...
/* Restituisce un valore calcolato attraverso la formula della curva gaussiana, prende come parametri due valori distinti (x e y) */
